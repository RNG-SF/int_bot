...
const ACCESS_DATA = {
    ...
    special: [
...

        {
            ...
            output: "link",
            link: "https://photos.app.goo.gl/mixdXJps2DTdaoq17",
            messageNo: //belum
        },

        {
            ...
            origin: "Palembang",
            output: "link",
            link: "https://photos.app.goo.gl/KTUmFDgQ5mwdM3kw6",
            messageNo: //belun
        },
...

        {
            ...
            origin: "Subang",
            output: "link",
            link: "https://photos.app.goo.gl/5NjJqBRk5W1ivzg17",
            messageNo: 1
        },
...

        {
            ...
            origin: "Temanggung",
            output: "link",
            link: "https://photos.app.goo.gl/d7MP5hWzAWEySHzw9",
            messageNo: //belum
        },
...

        {
            ...
            origin: "",
            output: "link",
            link: "https://photos.app.goo.gl/L6EqRe55fwApJgrh8",
            messageNo: //belum
        },
...

        {
            ...
            password2: OWNER_BACKUP_PASSWORD,
            output: "link",
            link: "https://photos.app.goo.gl/S7QjufBv5nSynz1q6",
            messageNo: 4
        },
...

        {
            ...
            birthday: "25112006",
            /* 25112006 hanya dipakai sebagai verifikasi tahap 2,
               bukan password pembuka tahap 1. */
            password1: null,
            password2: OWNER_BACKUP_PASSWORD,
            output: "notice",
            messageNo: 1
    ...
    /* =====================================================
       GATEWAY / SUPER SPECIAL
       -----------------------------------------------------
       252012 = pintu pertama.
       Setelah berhasil, pengguna memilih apakah ingin
       melanjutkan ke verifikasi orang terdekat.
       ===================================================== */
    superSpecial: [
        {
            id: "gateway-01",
            ...
            birthday: "25112006",
            password1: "252012",
            ownerBirthday: OWNER_BACKUP_PASSWORD,
            output: "notice",
            messageNo: 1,
            enabled: true
        }
    ...
    /* Pesan fallback ketika tanggal lahir pengguna tidak ditemukan. */
    fallbackMessages: {
        unknownBirthday: "Maaf, sepertinya aku belum mengenali tanggal yang kamu masukkan. Mungkin kamu memang belum pernah masuk ke daftar kecil ini, atau mungkin aku yang belum menyimpanmu dengan benar. Maaf karena pintu ini belum bisa terbuka untukmu. 🤍"
    }
